...
public class FreeMoveCam : MonoBehaviour
{
    ...
    float AccelerationMod = 0.1f;
    float DecelerationMod = 0.1f;
    float MaximumMovementSpeed = 0.1f;
    float MaxXAngle = 80f;
    ...
    public void ChangeSens(float NewSpeed)
    {
        axisSensitivity = NewSpeed;
    }
    ...
    {
        //mouse input
        var rotationHorizontal = axisSensitivity * Input.GetAxis("Mouse X");
        var rotationVertical = axisSensitivity * Input.GetAxis("Mouse Y");
